...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Pour pouvoir, à partir d'une série de données, réaliser un ajout dans le DOM, on peut, un par un parcourir le listing des éléments et agir sur l'élément en court d'itération. Pour cela, on va utiliser une boucle de type for...each. En Javascript, on peut faire cela via la cqdsvvméthode d'Array .forEach()
